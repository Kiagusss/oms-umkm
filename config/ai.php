...
return [
    ...
    */
    ...
    'default' => env('AI_DEFAULT_PROVIDER', 'chat'),
    ...
    */
    ...
    'providers' => [
        ...
        'openai-compatible' => [
            ...
            'models' => [
                'text' => [
                    'default' => env('OPENAI_COMPATIBLE_MODEL', 'gpt-4o-mini'),
                ],
            ],
        ],

        // Generic OpenAI-compatible endpoint — provider 'chat' yang dipakai
        // sebagai default di project ini. URL & model dibaca langsung dari
        // env (CHAT_API_BASE & CHAT_MODEL). Endpoint bisa apa pun (gateway
        // internal, 9router tunnel, Ollama, LM Studio, dll) — tidak terikat
        // pada provider resmi seperti OpenAI/Anthropic.
        'chat' => [
            'driver' => 'openai-compatible',
            'url' => env('CHAT_API_BASE', 'https://rzgwipd.abc-tunnel.us/v1'),
            'key' => env('LOCAL_AI_API_KEY', env('DEEPSEEK_API_KEY', env('CHAT_API_KEY'))),
            'models' => [
                'text' => [
                    'default' => env('CHAT_MODEL', 'gratis'),
                ],
            ],
        ],
