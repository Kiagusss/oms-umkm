@php
    $publishedArticles = $articles->filter(fn($a) => $a->status === 'published')->take(3);
@endphp

@if($publishedArticles->count() > 0)
<section id="artikel" class="bg-[var(--color-paper)] py-16 sm:py-20 lg:py-24">
    <div class="mx-auto max-w-7xl px-5 sm:px-8">
        <div class="mb-10 sm:mb-14">
            <h2 class="text-2xl font-bold tracking-tight sm:text-3xl lg:text-4xl" style="color: var(--color-ink)">Artikel Terbaru</h2>
